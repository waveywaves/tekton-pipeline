...
func (in *PipelineRunStatusFields) DeepCopyInto(out *PipelineRunStatusFields) {
	*out = *in
	...
	if in.LoopStates != nil {
		in, out := &in.LoopStates, &out.LoopStates
...
func (in *Loop) DeepCopyInto(out *Loop) {
	*out = *in
	if in.IterationParams != nil {
		in, out := &in.IterationParams, &out.IterationParams
		*out = make(Params, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoopIterationState) DeepCopyInto(out *LoopIterationState) {
	*out = *in
	if in.Results != nil {
		in, out := &in.Results, &out.Results
		*out = make([]TaskRunResult, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoopIterationState.
func (in *LoopIterationState) DeepCopy() *LoopIterationState {
	if in == nil {
		return nil
	}
	out := new(LoopIterationState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoopState) DeepCopyInto(out *LoopState) {
	*out = *in
	if in.Iterations != nil {
		...
		*out = make([]LoopIterationState, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
